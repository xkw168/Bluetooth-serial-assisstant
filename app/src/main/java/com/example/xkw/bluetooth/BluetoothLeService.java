...
public class BluetoothLeService extends Service {
    ...
    public final static String ACTION_DATA_CHANGED =
            "com.example.bluetooth.le.ACTION_DATA_CHANGED";
    public final static String ACTION_DATA_AVAILABLE =
            "com.example.bluetooth.le.ACTION_DATA_AVAILABLE";

    public final static UUID UUID_DEVICE_SERVICE = UUID.fromString(BluetoothData.DEVICE_SERVICE);
    ...
    private void broadcastUpdate(final String action,
        ...
        if (ACTION_DATA_READ.equals(action)){
            Log.d(TAG, "broadcastUpdate: action_data_read");
        }else if (ACTION_DATA_CHANGED.equals(action)){
            Log.d(TAG, "broadcastUpdate: action_data_changed");
        }
        if (UUID.fromString(BluetoothData.DEVICE_SERVICE).equals(characteristic.getUuid())) {
    ...
    public void readCharacteristic(BluetoothGattCharacteristic characteristic) {
        ...
        //readCharacteristic调用成功会回调BluetoothGattCallback中的onCharacteristicRead函数
    ...
    public void writeCharacteristic(BluetoothGattCharacteristic characteristic) {
        ...
        //writeCharacteristic调用成功会回调BluetoothGattCallback中的onCharacteristicWrite函数
